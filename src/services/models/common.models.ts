...
export const SaveMotorDetailRequestSchema = z.object({
	...
	PreviousInsuranceYN: z.string(),
	PreviousLossRatio: z.string(),
	...
	CollateralCompanyAddress: z.string(),
	CollateralCompanyName: z.string(),
	...
	AccessoriesInformation: z.string(),
