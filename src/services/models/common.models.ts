...
export const SaveMotorDetailRequestSchema = z.object({
	...
	NcdYn: z.string().nullable(),
	VehicleType: z.string(),
	VehicleTypeId: z.string(),
	CarAlarmYn: z.string().optional(),
	...
	SearchFromApi: z.boolean().optional(),
	...
	PreviousInsuranceYN: z.string().nullable(),
	PreviousLossRatio: z.string().nullable(),
	PolicyRenewalYn: z.string(),
	NewValue: z.string().nullable(),
	NoOfClaims: z.string().nullable(),
	NoOfClaimYears: z.string().nullable(),
	NoOfPassengers: z.string().nullable(),
	NoOfVehicles: z.string(),
	NumberOfAxels: z.string().nullable(),
	NumberOfCards: z.string().nullable(),
	OrginalPolicyNo: z.string().nullable(),
	OwnerCategory: z.string().nullable(),
	PaCoverId: z.string().nullable(),
	periodOfInsurance: z.number().nullable(),
	MunicipalityTraffic: z.string().nullable(),
	Ncb: z.string().optional(),
	ModelNumber: z.string().nullable(),
	MotorCategory: z.string().nullable(),
	MarketValue: z.string().nullable(),
	Mileage: z.string().nullable(),
	InsurancetypeDesc: z.string().nullable(),
	InsurerSettlement: z.string(),
	InterestedCompanyDetails: z.string(),
	IsFinanceEndt: z.string().nullable(),
	LoanAmount: z.number().nullable(),
	LoanEndDate: z.string().nullable(),
	LoanStartDate: z.string().nullable(),
	InsuranceClassDesc: z.string().nullable(),
	InflationSumInsured: z.string().optional(),
	...
	DriverDetails: z
		.object({
			...
			CreatedBy: z.string(),
			Deductibles: z.string().nullable(),
			DefenceValue: z.string(),
			DriverDob: z.string(),
			DriverExperience: z.number(),
			DriverName: z.string(),
			DriverType: z.string(),
			EndorsementDate: z.string().nullable(),
			EndorsementEffectiveDate: z.string().nullable(),
			EndorsementRemarks: z.string().nullable(),
			EndorsementType: z.string().nullable(),
			EndorsementTypeDesc: z.string().nullable(),
			EndorsementYn: z.string(),
			EndtCategoryDesc: z.string().nullable(),
			EndtCount: z.string().nullable(),
			EndtPrevPolicyNo: z.string().nullable(),
			EndtPrevQuoteNo: z.string().nullable(),
			EndtStatus: z.string().nullable(),
			ExcessLimit: z.string().nullable(),
			Gender: z.string(),
			Inflation: z.string(),
			InsuranceId: z.string(),
			IsFinanceEndt: z.string().nullable(),
	...
	ExcessLimit: z.string().nullable().optional(),
	DateOfCirculation: z.string().nullable(),
	CubicCapacity: z.string().nullable(),
	CollateralCompanyAddress: z.string().nullable(),
	CollateralCompanyName: z.string().nullable(),
	Color: z.string().nullable(),
	CommissionType: z.string().nullable(),
	CoverNoteNo: z.string().nullable(),
	CityLimit: z.string().nullable(),
	BrokerCode: z.string(),
	AxelDistance: z.string(),
	BankingDelegation: z.string(),
	AggregatedValue: z.string().nullable(),
	AccessoriesInformation: z.string().nullable(),
	VehicleClass: z.string().nullable(),
	accident: z.string().nullable(),
	AcExecutiveId: z.string().nullable(),
	AdditionalCircumstances: z.string().nullable(),
	VehicleTypeIvr: z.string(),
	ClaimRatio: z.string().nullable(),
...
export const premiumCalcDataSchema = z.unknown()
// z.object({
// CoverList: z.array(
// 	z.object({
// 		CoverId: z.string(),
	...
	Result: z.array(
		z.object({
			...
			CoverList: z.array(
				z.union([
					z.object({
						...
						Taxes: z
							.array(
								z.object({
									...
									MinimumTaxAmountLC: z.number(),
									TaxAmountLc: z.number(),
									TaxFor: z.string().nullable(),
									extend_Cust_tax: z.null()
								})
							)
							.nullable(),
						SubCovers: z
							.array(
								z.object({
									...
									Rate: z.number(),
									SubCoverId: z.string(),
									SubCoverDesc: z.string(),
									SubCoverName: z.string(),
									SectionId: z.string(),
									Discounts: z.string().nullable(),
									Taxes: z
										.array(
										...
										.nullable(),
									SubCovers: z.null(),
									FactorTypeId: z.string().nullable(),
									DependentCoverYN: z.string(),
									DependentCoverId: z.string(),
									Exception: z.null(),
									Loadings: z
										.array(
											z.object({
												LoadingId: z.string(),
												LoadingDesc: z.string(),
												LoadingRate: z.string(),
												LoadingAmount: z.string().nullable(),
												LoadingCalcType: z.string(),
												LoadingForId: z.string().nullable(),
												SubCoverId: z.string().nullable(),
												MaxLoadingAmount: z.string().nullable(),
												FactorTypeId: z.string(),
												RegulatoryCode: z.string().nullable(),
									...
									Currency: z.string(),
									isReferal: z.string(),
									ReferalDescription: z.string().nullable(),
									ProRata: z.number(),
									RegulatorSumInsured: z.number().nullable(),
									RegulatorRate: z.number().nullable(),
									UserOpt: z.string().nullable(),
									CoverBasedOn: z.string(),
									RegulatoryCode: z.string(),
									...
									DiffPremiumIncludedTaxLC: z.number(),
									CoverageLimit: z.number(),
									MinSumInsured: z.string().nullable(),
									PolicyPeriod: z.string().nullable(),
									IsTaxExcempted: z.string().nullable(),
									FreeCoverLimit: z.number(),
									CoverNameLocal: z.string(),
									CoverDescLocal: z.string(),
									SubCoverDescLocal: z.string(),
									SubCoverNameLocal: z.string(),
									LocationId: z.string(),
									MinRate: z.number(),
									MinimumRateYn: z.string(),
									ActualRate: z.number()
								})
							)
							.nullable(),
						...
						UserOpt: z.string().nullable(),
						CoverBasedOn: z.string().nullable(),
						RegulatoryCode: z.string().nullable(),
						InsuranceId: z.string(),
						BranchCode: z.string().nullable(),
						AgencyCode: z.string().nullable(),
						...
						Status: z.string(),
						DiffPremiumIncludedTax: z.number(),
						DiffPremiumIncludedTaxLC: z.number().nullable(),
						CoverageLimit: z.number(),
						MinSumInsured: z.string().nullable(),
						PolicyPeriod: z.string().nullable(),
						IsTaxExcempted: z.string().nullable(),
						...
						CoverNameLocal: z.string(),
						CoverDescLocal: z.string(),
						SubCoverDescLocal: z.string().nullable(),
						SubCoverNameLocal: z.string().nullable(),
						LocationId: z.string(),
						MinRate: z.number(),
						MinimumRateYn: z.string(),
						ActualRate: z.number()
					...
					z.object({
						...
						DiffPremiumIncludedTaxLC: z.number().nullable(),
						CoverageLimit: z.number(),
						MinSumInsured: z.null(),
						PolicyPeriod: z.null(),
						IsTaxExcempted: z.null(),
						FreeCoverLimit: z.number(),
						CoverNameLocal: z.string(),
						CoverDescLocal: z.string(),
						SubCoverDescLocal: z.null(),
						SubCoverNameLocal: z.null(),
						LocationId: z.string(),
						MinRate: z.number(),
						MinimumRateYn: z.string(),
						ActualRate: z.number()
					...
					z.object({
						...
						Taxes: z.array(
							z.object({
								...
								TaxAmount: z.number(),
								TaxDesc: z.string(),
								TaxExemptType: z.null(),
								TaxExemptCode: z.string(),
								TaxCalcType: z.string(),
								RegulatoryCode: z.null(),
								EndtTypeId: z.null(),
								EndtTypeCount: z.null(),
								DependentYN: z.string(),
								TaxExemptedAllowed: z.null(),
								MinimumTaxAmount: z.number(),
								MinimumTaxAmountLC: z.number(),
								TaxAmountLc: z.number(),
								TaxFor: z.null(),
									...
									Loadings: z
										.array(
											z.object({
												...
												LoadingDesc: z.string(),
												LoadingRate: z.string(),
												LoadingAmount: z.null(),
												LoadingCalcType: z.string(),
												LoadingForId: z.null(),
												SubCoverId: z.null(),
												MaxLoadingAmount: z.null(),
												FactorTypeId: z.string(),
												RegulatoryCode: z.null(),
					...
					z.object({
						...
						SubCovers: z
							...
							.nullable(),
						FactorTypeId: z.string().nullable(),
						DependentCoverYN: z.string().nullable(),
						DependentCoverId: z.string().nullable(),
						Exception: z.string().nullable(),
						Loadings: z
							.array(
								z.object({
						...
						MultiSelectYn: z.string(),
						SectionName: z.string(),
						ExcessPercent: z.string().nullable(),
						ExcessAmount: z.string().nullable(),
						ExcessDesc: z.string().nullable(),
						MinimumPremiumYn: z.string().nullable(),
						ProRataApplicable: z.string(),
						Endorsements: z.string().nullable(),
						EndtCount: z.string().nullable(),
						EffectiveDate: z.string(),
						PolicyEndDate: z.string(),
						Status: z.string().nullable(),
						DiffPremiumIncludedTax: z.number().nullable(),
						DiffPremiumIncludedTaxLC: z.number().nullable(),
						CoverageLimit: z.number().nullable(),
						MinSumInsured: z.string().nullable(),
						PolicyPeriod: z.string().nullable(),
						IsTaxExcempted: z.string().nullable(),
						FreeCoverLimit: z.string().nullable(),
						CoverNameLocal: z.string(),
						CoverDescLocal: z.string(),
						SubCoverDescLocal: z.string().nullable(),
						SubCoverNameLocal: z.string().nullable(),
						...
						MinimumRateYn: z.string().nullable(),
						ActualRate: z.null()
					})
				])
			),
			...
			RiskDetails: z.object({
				...
				RegistrationAge: z.null(),
				NcdYears: z.number(),
				NcdYn: z.string(),
				ManufactureYear: z.string(),
				CollateralYn: z.string(),
				BorrowerType: z.null(),
				...
				ClaimRatio: z.string(),
				CityLimit: z.null(),
				DocumentsTitle: z.null(),
				SavedFrom: z.string(),
				DriverDetails: z.null(),
				SectionId: z.string(),
				SectionName: z.string(),
				SectionDetails: z.null(),
				EndorsementYn: z.string(),
				EndtCount: z.null(),
				EffectiveDate: z.null(),
				PremiumLc: z.null(),
				PremiumFc: z.null(),
				OverAllPremiumFc: z.null(),
				OverAllPremiumLc: z.null(),
				CommissionAmount: z.null(),
				CommissionPercentage: z.string(),
				VatCommission: z.null(),
			...
			DueAmount: z.null(),
			ReferalRemarks: z.null(),
			ManualReferalYn: z.null(),
			SectionName: z.string(),
			EndorsementYn: z.string(),
			EndtCount: z.null(),
			EffectiveDate: z.null(),
			EndtTypeMaster: z.null(),
			AccessoriesSumInsured: z.number(),
			CommissionPercentage: z.string(),
			VatCommission: z.string(),
			PolicyNo: z.null(),
			OriginalPolicyNo: z.null(),
			SourceType: z.string(),
			FinalizeYn: z.string(),
...
export const DocumentTypeResponseSchema = z.object({
	...
	Result: z.array(
		z.object({
			Code: z.string(),
			CodeDesc: z.string(),
			MandatoryStatus: z.string().optional()
		})
	),
	ErroCode: z.number()
})
