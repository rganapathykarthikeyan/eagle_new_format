	...
	Result: z.array(
		z.object({
			...
			CoverList: z.array(
				z.union([
					z.object({
						...
						DiffPremiumIncludedTaxLC: z.null(),
						CoverageLimit: z.number(),
					...
					z.object({
						...
						SubCovers: z.array(
							z.object({
								...
								Currency: z.string(),
								isReferal: z.string(),
								ReferalDescription: z.null(),
								ProRata: z.number(),
								RegulatorSumInsured: z.null(),
								RegulatorRate: z.null(),
								UserOpt: z.string(),
								CoverBasedOn: z.string(),
								RegulatoryCode: z.string(),
								InsuranceId: z.string(),
						...
						FactorTypeId: z.null(),
						DependentCoverYN: z.null(),
						DependentCoverId: z.null(),
						Exception: z.null(),
						Loadings: z.null(),
						CoverageType: z.string(),
						isSelected: z.string(),
						...
						MultiSelectYn: z.string(),
						SectionName: z.string(),
						ExcessPercent: z.null(),
						ExcessAmount: z.null(),
						ExcessDesc: z.null(),
						MinimumPremiumYn: z.null(),
						ProRataApplicable: z.string(),
						Endorsements: z.null(),
						EndtCount: z.null(),
						EffectiveDate: z.string(),
						PolicyEndDate: z.string(),
						Status: z.null(),
						DiffPremiumIncludedTax: z.null(),
						DiffPremiumIncludedTaxLC: z.null(),
						CoverageLimit: z.null(),
						MinSumInsured: z.null(),
						PolicyPeriod: z.null(),
						IsTaxExcempted: z.null(),
						FreeCoverLimit: z.null()
					}),
					z.object({
						CoverId: z.string(),
						CalcType: z.string(),
			...
			RiskDetails: z.object({
				...
				VatCommission: z.string().nullable(),
